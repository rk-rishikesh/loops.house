...
import {
  ArrowLeft, ArrowUpRight, Send, FileText,
  CheckCircle, Clock, Trophy, BookOpen, Users,
  HelpCircle, Zap, Globe, ChevronDown, ChevronUp,
  MessageSquare, Plus,
} from "lucide-react";
...
function PageSkeleton() {
  return (
    <div className="min-h-screen px-10 pt-20" style={{ backgroundColor: "#f0ebe0" }}>
      <div className="animate-pulse flex flex-col gap-6">
        <div className="h-3 w-20 rounded" style={{ backgroundColor: "rgba(45,74,62,0.08)" }} />
        <div className="h-20 w-2/3 rounded-2xl" style={{ backgroundColor: "rgba(45,74,62,0.07)" }} />
        <div className="h-4 w-1/3 rounded" style={{ backgroundColor: "rgba(45,74,62,0.05)" }} />
        <div className="grid grid-cols-2 gap-4 mt-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-36 rounded-2xl" style={{ backgroundColor: "rgba(45,74,62,0.05)" }} />
          ))}
        </div>
      </div>
    </div>
...
export default function IndividualBoosterPage() {
  ...
  if (booster === undefined) return <PageSkeleton />;
          ...
          <div className="flex flex-col gap-4">
            ...
            {booster.problem_statements.length > 0 && (
              <div className="rounded-3xl p-7 relative overflow-hidden" style={{ backgroundColor: "#2d4a3e" }}>
                ...
                <h2 className="font-black text-[#f0ebe0] uppercase mb-6"
            ...
            {hasTracks && (
              <div className="rounded-3xl p-7" style={{ backgroundColor: "#f5f2ea" }}>
                ...
                <h2 className="font-black text-[#2d4a3e] uppercase mb-5"
