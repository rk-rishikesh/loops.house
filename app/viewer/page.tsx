...
import { Code2, MessageSquare, ArrowLeft, ArrowUpRight, Search, X } from "lucide-react";
        ...
        <div>
          ...
          >
            ...
            {p.tagline && (
              <>
                <br />
                <span className="font-normal text-[#2d4a3e]/50" style={{ fontFamily: "Georgia, serif", fontSize: "0.95em" }}>
                  {p.tagline}
                </span>
              </>
            )}
        ...
        <div className="mb-16">
          ...
          <div className="flex mt-8 justify-end">
            <div className="flex flex-col">
              ...
              <div className="relative w-full max-w-[300px] justify-end">
                <Search
                  size={14}
                  className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#2d4a3e]/35 pointer-events-none"
                />
                <input
                  type="text"
                  value={search}
                  ...
                  onFocus={(e) => (e.currentTarget.style.borderColor = "rgba(45,74,62,0.5)")}
                  onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(45,74,62,0.2)")}
                />
                {search && (
                  <button
                    type="button"
                    onClick={() => setSearch("")}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#2d4a3e]/40 hover:text-[#2d4a3e] transition-colors"
                  >
                    <X size={12} />
                  </button>
                )}
