      ...
      <div className="px-10 pt-10 pb-32">
        ...
        <div className="mb-20">
          ...
          <div className="flex justify-end mt-8">
            ...
            >
              Welcome to the command center for <span className="font-bold text-[#0F2C23]">{hackathon.name}</span>. 
              Manage your core configuration, speaker lineup, and judging committee from one place.
            </p>
          </div>
        </div>
                ...
                <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <pattern id="neural-grid" width="40" height="40" patternUnits="userSpaceOnUse">
                      ...
                      <path d="M 2 2 L 40 40 M 40 2 L 2 40" stroke="#E2FEA5" strokeWidth="0.5" opacity="0.3" />
                    </pattern>
                  </defs>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-black text-[#F8FFE8] uppercase tracking-wide leading-none mb-1" style={{ fontFamily: PX, fontSize: 26 }}>
                          AUTONOMOUS AGENTS
                        </h3>
                        <div className="flex items-center gap-2">
                          <span className="w-2 h-2 rounded-full bg-[#E2FEA5] animate-pulse" />
                          <span className="text-[10px] uppercase font-bold text-[#E2FEA5]/60 tracking-widest" style={{ fontFamily: PX }}>System Online</span>
                        </div>
                      </div>
                    </div>
                  </div>

                  <p className="text-[#F8FFE8]/70 leading-relaxed mb-12 max-w-xl" style={{ fontFamily: FN, fontSize: 18 }}>
                    Your program data isn't just stored; it's <span className="text-[#E2FEA5] font-medium italic underline decoration-[#E2FEA5]/30 underline-offset-4">synthesized</span>. 
                    Every deadline and prize detail feeds a custom AI Agent designed to guide your builders through the complexity of your specific program logic.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={stat.label} className="bg-white/5 border border-white/10 rounded-3xl p-5 backdrop-blur-sm transition-colors hover:bg-white/10">
                      <div className="text-[#E2FEA5] mb-2">{stat.icon}</div>
                      <p className="text-[9px] uppercase font-bold text-[#F8FFE8]/30 mb-1" style={{ fontFamily: PX }}>{stat.label}</p>
                      <p className="text-[#F8FFE8] text-xs font-bold leading-tight" style={{ fontFamily: FN }}>{stat.text}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            >
              <div>
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="font-black text-[#0F2C23] uppercase tracking-wide leading-none" style={{ fontFamily: PX, fontSize: 22 }}>
                    KNOWLEDGE SYNC
                  </h3>
                </div>
                
                <p className="text-[#0F2C23]/70 leading-relaxed mb-10" style={{ fontFamily: FN, fontSize: 16 }}>
                  Our <span className="font-bold text-[#0F2C23] uppercase text-[13px] tracking-tight">RAG Pipeline</span> mirrors your every move. 
                  Edit a field, and our vector engine re-indexes the builder-facing intelligence in <span className="font-bold text-[#0F2C23]">~240ms</span>.
                </p>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-center justify-between py-3 border-b border-[#0F2C23]/10">
                      <span className="text-[10px] uppercase font-bold text-[#0F2C23]/40 tracking-wider" style={{ fontFamily: PX }}>{item.label}</span>
                      <span className="text-xs font-black text-[#0F2C23]" style={{ fontFamily: PX }}>{item.value}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="mt-8 p-6 bg-[#0F2C23]/5 rounded-[32px] border border-[#0F2C23]/5">
                <div className="flex items-center gap-3">
                   <div className="flex -space-x-2">
                    {[1, 2, 3].map(i => (
                      <div key={i} className="w-6 h-6 rounded-full border-2 border-[#E2FEA5] bg-[#0F2C23]/10 flex items-center justify-center">
                        <Users size={10} className="text-[#0F2C23]/40" />
                      </div>
                    ))}
                   </div>
                   <p className="text-[10px] text-[#0F2C23]/60 font-medium" style={{ fontFamily: FN }}>
